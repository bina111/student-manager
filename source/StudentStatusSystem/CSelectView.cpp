...
void CSelectView::OnInitialUpdate()
{
	...
	HICON icon = AfxGetApp()->LoadIconW(IDI_ICON_RER);
	...
	//2、添加节点
	m_treeCtrl->InsertItem(_T("系统管理"), 0, 0, NULL);
	m_treeCtrl->InsertItem(_T("学生管理"), 0, 0, NULL);
	m_treeCtrl->InsertItem(_T("成绩管理"), 0, 0, NULL);
	m_treeCtrl->InsertItem(_T("课程管理"), 0, 0, NULL);
